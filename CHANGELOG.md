...
- Fixed
  - Moved README badges from .svg to .png (SVGs seem to be forbidden by Visual Studio Marketplace)
...
- Fixed
  - Issue preventing the extension from being published to Visual Studio Marketplace
...
- Updated
  - Users can now select OAuth scopes by checking checkboxes

## [2.11.0] - 2025-10-07

- Added
  - Additional commands for SSAs (copying account/key IDs to clipboard, and viewing key details)
  - Automated management (registration, contributes, etc) of commands using decorators
- Updated
  - IDs, categories, and titles of commands
  - Simplified command input checks
...
- Added
  ...
  - Support for additional webhooks
- Fixed
